# Example Memory Management Chatbot
...
Aside from the bug mentioned above, there are five additional major tasks in the Memory Management chatbot project, which are:
