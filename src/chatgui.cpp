...
bool ChatBotApp::OnInit()
{
    ...
    ChatBotFrame *chatBotFrame = new ChatBotFrame(wxT("John's ChatBot"));
    ...
    : wxScrolledWindow(parent, id)
{
    ...
    _chatLogic = std::make_unique<ChatLogic>();                         // *********** Task 1.  Making _chatLogic an exclusive resource. *********************                         
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    ...
    // delete _chatLogic;                                               // ******************* Task 1. I can get rid of this now. ****************************
